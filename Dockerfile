...
LABEL "repository"="https://github.com/better-boards/amplify-cli-action"
LABEL "homepage"="https://github.com/better-boards/amplify-cli-action.git"

LABEL org.opencontainers.image.source=https://github.com/better-boards/amplify-cli-action
